 ...
 * `tests/mobile-smoke.spec.ts`). A listed route also covers its descendants,
 * so listing `/[organization]/[project]/-/ai` also opts in
 * `/[organization]/[project]/-/ai/[conversationId]`.
 *
 * Intentionally empty until the first surface is migrated.
 */
...
/**
 * Whether the given route id opts into the device viewport. Matches a listed
 * route exactly, or any descendant of one (e.g. a `[conversationId]` child of a
 * listed `-/ai` route).
 */
