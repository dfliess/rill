<script lang="ts">
  ...
  import { DashboardTableSortOptions } from "@rilldata/web-admin/features/dashboards/listing/dashboard-favourites.ts";
...
<ContentContainer maxWidth={900}>
  <div class="flex flex-col gap-y-8 py-12">
    <!-- Welcome heading: the page header, above the executive strip -->
    ...
    <!-- Canvases annotated with kairos_home: the executive numbers strip,
    ...
    <!-- Recently triggered alerts (awareness feed, after the actionable
         approvals) -->
